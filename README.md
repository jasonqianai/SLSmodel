...
3.	Demo:
  ...
  •	Expected output: When you open the .mlx file in MATLAB, expected output will show up on the side of MATLAB window. You can also find the a xxx.pdf file to view the expected output.
...
4.	Instructions for use
  ...
  •	Reproduction instructions: To reproduce the density maps in the manuscript, we need to
      ...
      ii.	Use the substrate structure illustrated in the density map you want to reproduce. E.g., for a mono-step HOPG, we can add another layer of graphene on top of existing flat area, with a interlayer spacing of 0.34 nm in z-direction, and a shift of 2.46 nm in x-direction. We can add this line to the code: “coor2 = [coor(1:30*36,1)+10*ringwidth, coor(1:30*36,2), zeros([30*36,1])];”. And the total substrate coordinates will be “atomcoor = [coor1; coor2; coor1u; coor2u; coor3u]; ”
